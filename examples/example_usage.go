...
func main() {
	...
	if err != nil {
		...
		if verifyResult.Result == zkgenomics.ProofSuccess {
	...
	mockProofData := &zkgenomics.ProofData{
		...
		Result:        zkgenomics.ProofSuccess,
	}
	...
	fmt.Println("\n=== Proof Result Types ===")
	results := []zkgenomics.ProofResult{
		zkgenomics.ProofSuccess,
		zkgenomics.ProofFail,
		zkgenomics.ProofUnknown,
	}
